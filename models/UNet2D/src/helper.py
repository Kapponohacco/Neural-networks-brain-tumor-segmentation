...
def get_filepath(brain_index: int, mod: str = "t1ce"):
    ...
    if formated_index == "355" and mod == "seg":
        path = (
            UNPROCESSED_DATASET_PATH / "BraTS20_Training_355" / "W39_1998.09.19_Segm.nii"
        )
    else:
        path = (
            UNPROCESSED_DATASET_PATH /
...
def get_cache(brain_index, mod):
    ...
    cache_path = DATASET_PATH / f"brain_{brain_index:03d}_{mod}.pt"
